...
/***********************************************************************
 * Module:  DispatchServiceImpl.java
 * Author:  dingpf
 * Purpose: Defines the Class DispatchServiceImpl
 ***********************************************************************/
...
public class DispatchServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(DispatchServiceImpl.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		DispatchServiceImpl.applicationContext = applicationContext;
