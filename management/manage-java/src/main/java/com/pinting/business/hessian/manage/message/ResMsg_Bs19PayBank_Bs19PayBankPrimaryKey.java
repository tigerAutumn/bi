...
public class ResMsg_Bs19PayBank_Bs19PayBankPrimaryKey extends ResMsg {
    ...
    public String getOneTop() {
    	if(StringUtil.isNotBlank(this.oneTop)){
			oneTop = new DecimalFormat("#.##").format(Double.parseDouble(this.oneTop.toString()));
    	}
		return oneTop;
	}
	...
	public String getDayTop() {
		if(StringUtil.isNotBlank(this.dayTop)){
			dayTop = new DecimalFormat("#.##").format(Double.parseDouble(this.dayTop.toString()));
    	}
		return dayTop;
	}
	...
	public String getMonthTop() {
		if(StringUtil.isNotBlank(this.monthTop)){
			monthTop = new DecimalFormat("#.##").format(Double.parseDouble(this.monthTop.toString()));
    	}
		return monthTop;
	}
