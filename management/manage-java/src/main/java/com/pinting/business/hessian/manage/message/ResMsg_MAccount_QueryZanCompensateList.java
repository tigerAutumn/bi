 ...
 */
public class ResMsg_MAccount_QueryZanCompensateList extends ResMsg {
    ...
    /* 代偿人账户余额 */
    private Double zanCompensateAmount;
    ...
    public Double getZanCompensateAmount() {
        return zanCompensateAmount;
    }

    public void setZanCompensateAmount(Double zanCompensateAmount) {
        this.zanCompensateAmount = zanCompensateAmount;
    }
