 ...
 * Author:      cyb
 * Date:        2017/4/3
 * Description: 统一  网关钱报178接入  接口实现
 */
public class GatewayQb178HessianServiceImpl extends HessianBaseService implements HessianService, ApplicationContextAware {

    protected static ApplicationContext applicationContext;
    private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory();

    private Logger log = LoggerFactory.getLogger(GatewayQb178HessianServiceImpl.class);
    ...
    public ResMsg handleMsg(ReqMsg reqMsg) {
        ...
        try {
            ...
            String resClassName = Constants.QB178_BUSINESS_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
    ...
    public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
        GatewayQb178HessianServiceImpl.applicationContext = applicationContext;
    }
