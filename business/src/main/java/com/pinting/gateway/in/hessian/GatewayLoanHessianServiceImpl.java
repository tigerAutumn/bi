 ...
 * 统一  网关借款接入  接口实现
 * @Project: business
 * @Title: GatewayLoanHessianServiceImpl.java
 * @author dingpf
 * @date 2016-8-17 下午8:09:17
 * @Copyright: 2016 BiGangWan.com Inc. All rights reserved.
 */
public class GatewayLoanHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(GatewayLoanHessianServiceImpl.class);
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.LOAN_BUSINESS_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		GatewayLoanHessianServiceImpl.applicationContext = applicationContext;
