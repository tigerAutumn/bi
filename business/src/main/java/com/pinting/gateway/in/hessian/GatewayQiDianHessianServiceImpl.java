 ...
 * 
 * @project business
 * @title GatewayQiDianHessianServiceImpl.java
 * @author Dragon & cat
 * @date 2018-3-21
 * @Copyright 2015 BiGangWan.com Inc. All rights reserved.
 * @Description
 */
public class GatewayQiDianHessianServiceImpl  extends HessianBaseService implements HessianService , ApplicationContextAware {

	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(GatewayQiDianHessianServiceImpl.class);
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.QIDIAN_BUSINESS_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		GatewayQiDianHessianServiceImpl.applicationContext = applicationContext;
