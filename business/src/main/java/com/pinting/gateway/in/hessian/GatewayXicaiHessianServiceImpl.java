 ...
 */
public class GatewayXicaiHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(GatewayXicaiHessianServiceImpl.class);
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.XICAI_BUSINESS_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		GatewayXicaiHessianServiceImpl.applicationContext = applicationContext;
