...
public class G2BReqMsg_Qb178_QueryOrderList  extends ReqMsg {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6612183852566658258L;
	/**产品编码*/
	...
	/**页数，起始值为1*/
	@NotNull(message="page_num为空")
	private		Integer		page_num;
	/**每页记录数*/
	@NotNull(message="page_size为空")
