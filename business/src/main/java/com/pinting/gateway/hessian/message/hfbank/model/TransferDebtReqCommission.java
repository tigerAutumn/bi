 ...
 * 
 * @project gateway
 * @title TransferDebtReqCommission.java
 * @author Dragon & cat
 * @date 2017-4-1
 * @Copyright 2015 BiGangWan.com Inc. All rights reserved.
 * @Description 恒丰银行存管 ，标的转让请求-出让人手续费说明
 */
public class TransferDebtReqCommission implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 6609243911600531041L;
	/*分配平台类型(01-自有 11-垫付)*/
