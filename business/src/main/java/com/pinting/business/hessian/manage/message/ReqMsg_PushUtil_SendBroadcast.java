...
public class ReqMsg_PushUtil_SendBroadcast extends ReqMsg {
	/**
	 * 序列化编号
	 */
	private static final long serialVersionUID = 1874118175900021133L;
	private String ticker; // 必填 通知栏提示文字
	private String title; // 必填 通知标题
	private String text; // 必填 通知文字描述
	private String displayType; // 必填 消息类型，值可以为:notification-通知，message-消息
	/**
	 * 自定义通知图标:
