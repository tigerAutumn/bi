package com.pinting.business.hessian.site.service;

/***********************************************************************
 * Module:  SiteHessianServiceImpl.java
 * Author:  dingpf
 * Purpose: Defines the Class SiteHessianServiceImpl
 ***********************************************************************/
 ...
 * 统一  接口实现
 * */
public class SiteHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(SiteHessianServiceImpl.class);
	
	private static String logExcludeTransCodes = "Home-ServerUsableCheck,";
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			if(logExcludeTransCodes.indexOf(transCode) < 0){
			...
			String resClassName = Constants.SITE_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
...
//			extendMap.put("sys_halt", Constants.sysValue);
//			extendMap.put("tran_halt", Constants.tranValue);
//			resMsg.setExtendMap(extendMap);
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		SiteHessianServiceImpl.applicationContext = applicationContext;
