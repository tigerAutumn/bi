...
public class ResMsg_MAccount_UserWithdraw extends ResMsg {
	...
	public Double getSumUserAmount() {
		return sumUserAmount;
	}

	public void setSumUserAmount(Double sumUserAmount) {
		this.sumUserAmount = sumUserAmount;
	}
