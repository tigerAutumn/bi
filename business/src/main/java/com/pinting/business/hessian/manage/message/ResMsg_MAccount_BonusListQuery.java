...
public class ResMsg_MAccount_BonusListQuery extends ResMsg {
	...
	public Double getSumBonusAmount() {
		return sumBonusAmount;
	}

	public void setSumBonusAmount(Double sumBonusAmount) {
