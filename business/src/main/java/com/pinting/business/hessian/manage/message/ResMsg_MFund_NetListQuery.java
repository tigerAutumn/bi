...
public class ResMsg_MFund_NetListQuery extends ResMsg{


	/**
	 * 
	 */
	private static final long serialVersionUID = -8526360105636598063L;
	private ArrayList<HashMap<String,Object>> netList;
	
	public ArrayList<HashMap<String, Object>> getNetList() {
		return netList;
	}

	public void setNetList(ArrayList<HashMap<String, Object>> netList) {
