 ...
 * 财务投资购买查询-云贷存管 vo
 */
public class BsStatisticsDepVO extends BsUser{
	...
	private String beginAmount;  //起始金额
	
	private String endAmount;	//结束金额
	...
	private Double balance;		//匹配金额
	
	private Double buyBalance;  //购买金额
	...
	private String investStartTime;		//起始时间
	
	private String investFinishTime;		//结束时间
	
	private String lastFinishInterestStartTime; //结算起始时间
	
	private String lastFinishInterestEndTime;  //结算结束时间
	...
	public String getInvestFinishTime() {
		return investFinishTime;
	}

	public void setInvestFinishTime(String investFinishTime) {
		this.investFinishTime = investFinishTime;
	}

	public String getLastFinishInterestStartTime() {
		return lastFinishInterestStartTime;
	}

	public void setLastFinishInterestStartTime(String lastFinishInterestStartTime) {
		this.lastFinishInterestStartTime = lastFinishInterestStartTime;
	}

	public String getLastFinishInterestEndTime() {
		return lastFinishInterestEndTime;
	}

	public void setLastFinishInterestEndTime(String lastFinishInterestEndTime) {
		this.lastFinishInterestEndTime = lastFinishInterestEndTime;
	}
