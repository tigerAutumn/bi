 ...
 */
public class AnniversaryThirdHomePageInfoVO {
    ...
    /* 五重礼今日年化投资额排行榜 */
    List<AnniversaryInvestUserInfoVO> todayInvestUserList;
    ...
    public List<AnniversaryInvestUserInfoVO> getTodayInvestUserList() {
        return todayInvestUserList;
    }

    public void setTodayInvestUserList(List<AnniversaryInvestUserInfoVO> todayInvestUserList) {
