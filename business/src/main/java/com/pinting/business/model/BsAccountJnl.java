...
public class BsAccountJnl extends PageInfoObject{

    @Override
	public String toString() {
		return "BsAccountJnl [id=" + id + ", transTime=" + transTime
				+ ", transCode=" + transCode + ", transType="
				+ transType + ", transName=" + transName
				+ ", transAmount=" + transAmount + ", sysTime="
				+ sysTime + ", channelTime=" + channelTime
				+ ", channelJnlNo=" + channelJnlNo
				+ ", cdFlag1=" + cdFlag1 + ", userId1="
				+ userId1 + ", accountId1=" + accountId1
				+ ", accountName1=" + accountName1
				+ ", subAccountId1=" + subAccountId1
				+ ", subAccountCode1=" + subAccountCode1
				+ ", beforeBalance1=" + beforeBalance1
				+ ", afterBalance1=" + afterBalance1
				+ ", beforeAvialableBalance1="
				+ beforeAvialableBalance1
				+ ", afterAvialableBalance1="
				+ afterAvialableBalance1
				+ ", beforeFreezeBalance1="
				+ beforeFreezeBalance1
				+ ", afterFreezeBalance1="
				+ afterFreezeBalance1 + ", cdFlag2=" + cdFlag2
				+ ", userId2=" + userId2 + ", accountId2="
				+ accountId2 + ", accountName2=" + accountName2
				+ ", subAccountId2=" + subAccountId2
				+ ", subAccountCode2=" + subAccountCode2
				+ ", beforeBalance2=" + beforeBalance2
				+ ", afterBalance2=" + afterBalance2
				+ ", beforeAvialableBalance2="
				+ beforeAvialableBalance2
				+ ", afterAvialableBalance2="
				+ afterAvialableBalance2
				+ ", beforeFreezeBalance2="
				+ beforeFreezeBalance2
				+ ", afterFreezeBalance2="
				+ afterFreezeBalance2 + ", fee=" + fee
				+ ", status=" + status + ", checkStatus="
				+ checkStatus + ", isCheck=" + isCheck
				+ ", respCode=" + respCode + ", respMsg="
				+ respMsg + ", relativeJnl=" + relativeJnl
				+ ", note=" + note + "]";
	}
    ...
    public String getRelativeJnl() {
        return relativeJnl;
    }

    public void setRelativeJnl(String relativeJnl) {
        this.relativeJnl = relativeJnl;
    }
