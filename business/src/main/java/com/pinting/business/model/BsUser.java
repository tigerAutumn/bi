...
public class BsUser extends PageInfoObject {

	/**
	 * 序列化编号
	 */
	private static final long serialVersionUID = 4807944152261185879L;
	...
	private Integer loginAlwaysFailTimes;
	...
	private Integer riskAssessScore;

	private Date riskAssessTime;
	...
	public Integer getLoginAlwaysFailTimes() {
		return loginAlwaysFailTimes;
	}

	public void setLoginAlwaysFailTimes(Integer loginAlwaysFailTimes) {
		this.loginAlwaysFailTimes = loginAlwaysFailTimes;
	}
	...
	public Integer getRiskAssessScore() {
		return riskAssessScore;
	}

	public void setRiskAssessScore(Integer riskAssessScore) {
		this.riskAssessScore = riskAssessScore;
	}

	public Date getRiskAssessTime() {
		return riskAssessTime;
	}

	public void setRiskAssessTime(Date riskAssessTime) {
		this.riskAssessTime = riskAssessTime;
	}
