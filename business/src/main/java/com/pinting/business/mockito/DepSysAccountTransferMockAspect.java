 ...
 *
 * @author SHENGP
 * @date  2017年5月10日 下午1:22:50
 */
//@Aspect
//@Component
public class DepSysAccountTransferMockAspect {
	...
	@Pointcut("execution(public * com.pinting.business.service.manage.impl.BsHfBankServiceImpl.sysAccountTransfer(..))")
