 ...
 * @2018-6-27 下午2:56:10
 */
@Service("transferGetNeedPay4FixedInstallmentServiceImpl")
public class TransferGetNeedPay4FixedInstallmentServiceImpl extends
	...
	public ResMsg execute(FlowContext flowContext) {
		return super.execute(flowContext);
	}
