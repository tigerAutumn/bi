...
public class CalBillPeriod {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(
        		calBillDays(successDate));
    }
    
    public static Integer calBillDays(Date successTime) {
    	long loanMoney = 10000;
    	double yearInterestRate = 0.437;
        ...
        for (int i = 0; i < repayPlans.size(); i++) {
            ...
            periods = periods + (int)plan.getDays();
        }
