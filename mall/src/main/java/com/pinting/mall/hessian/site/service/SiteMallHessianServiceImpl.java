package com.pinting.mall.hessian.site.service;

/***********************************************************************
 * Module:  SitemallHessianServiceImpl.java
 * Author:  dingpf
 * Purpose: Defines the Class SitemallHessianServiceImpl
 ***********************************************************************/
 ...
 * 统一  接口实现
 * */
public class SiteMallHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(SiteMallHessianServiceImpl.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		SiteMallHessianServiceImpl.applicationContext = applicationContext;
