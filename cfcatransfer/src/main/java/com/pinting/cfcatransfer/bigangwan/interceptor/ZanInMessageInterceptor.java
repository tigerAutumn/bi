 ...
 */
public class ZanInMessageInterceptor extends HandlerInterceptorAdapter {
	private Logger log = LoggerFactory
			.getLogger(ZanInMessageInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request,
		...
		//解密报文
		BaseReqModel model = ZANInMsgUtil.parseMsg(encryptData);
		if(model == null){
