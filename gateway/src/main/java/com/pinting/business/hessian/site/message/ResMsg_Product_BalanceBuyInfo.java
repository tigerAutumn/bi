 ...
 * 
 * @project gateway
 * @title ResMsg_Product_BalanceBuyInfo.java
 * @author Dragon & cat
 * @date 2017-4-14
 * @Copyright 2015 BiGangWan.com Inc. All rights reserved.
 * @Description  余额购买页面信息
 */
public class ResMsg_Product_BalanceBuyInfo extends ResMsg {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3388612457938180755L;
