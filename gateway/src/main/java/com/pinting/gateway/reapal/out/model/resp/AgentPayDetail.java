...
public class AgentPayDetail {
	...
	public String toString() {
		return "AgentPayDetail [tradeNum=" + tradeNum + ", tradeCardnum="
				+ tradeCardnum + ", tradeCardname=" + tradeCardname
				+ ", tradeBranchbank=" + tradeBranchbank
				+ ", tradeSubbranchbank=" + tradeSubbranchbank
				+ ", tradeAccountname=" + tradeAccountname
				+ ", tradeAccounttype=" + tradeAccounttype + ", tradeAmount="
				+ tradeAmount + ", tradeAmounttype=" + tradeAmounttype
				+ ", tradeRemark=" + tradeRemark + ", contractUsercode="
				+ contractUsercode + ", tradeFeedbackcode=" + tradeFeedbackcode
