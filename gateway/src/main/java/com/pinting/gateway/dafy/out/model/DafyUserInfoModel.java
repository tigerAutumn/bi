...
public class DafyUserInfoModel {
	...
	private String strDeptCode0;
	
	private String strDeptCode1;
	
	private String strDeptCode2;
	
	private String strDeptCode3;
	
	private String strDeptCode4;
	
	private String strDeptCode5;
	
	private String strDeptCode6;
	
	private String strDeptCode7;
	
	private String strDeptCode8;
	
	private String strDeptCode9;
	...
	public Integer getnManager() {
		return nManager;
	}

	public void setnManager(Integer nManager) {
	...
	public Integer getnWorkState() {
		return nWorkState;
	}

	public void setnWorkState(Integer nWorkState) {
		this.nWorkState = nWorkState;
	}
