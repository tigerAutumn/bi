...
/**
 * Dafy 统一  Business Hessian接入  接口实现
 * @Project: gateway
 * @Title: BsDafyHessianServiceImpl.java
 * @author dingpf
 * @date 2015-2-10 下午2:17:40
 * @Copyright: 2015 BiGangWan.com Inc. All rights reserved.
 */
public class DafyGatewayHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(DafyGatewayHessianServiceImpl.class);
	private static String logExcludeTransCodes = "Payment-ServerUsableCheck,";
	/**
	 * 负责 消息请求接收及响应
	 * 负责 实现业务服务的分派
	 * @param reqMsg
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.BUSINESS_DAFY_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		DafyGatewayHessianServiceImpl.applicationContext = applicationContext;
