 ...
 */
public class NoticeGatewayHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(NoticeGatewayHessianServiceImpl.class);
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.BUSINESS_LOAN_NOITCE_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		NoticeGatewayHessianServiceImpl.applicationContext = applicationContext;
