...
/**
 * 希财 统一  Business Hessian接入  接口实现
 * @Project: gateway
 * @Title: XicaiGatewayHessianServiceImpl.java
 * @author dingpf
 * @date 2015-2-10 下午2:17:40
 * @Copyright: 2015 BiGangWan.com Inc. All rights reserved.
 */
public class XicaiGatewayHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(XicaiGatewayHessianServiceImpl.class);
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.BUSINESS_XICAI_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		XicaiGatewayHessianServiceImpl.applicationContext = applicationContext;
