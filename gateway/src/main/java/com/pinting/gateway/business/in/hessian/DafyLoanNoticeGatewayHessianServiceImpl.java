 ...
 */
public class DafyLoanNoticeGatewayHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(DafyLoanNoticeGatewayHessianServiceImpl.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		DafyLoanNoticeGatewayHessianServiceImpl.applicationContext = applicationContext;
