 ...
 * 统一网关接入接口实现
 * @author SHENGUOPING
 * @date  2017年12月13日 上午11:03:55
 */
public class DepLoan7NoticeGatewayHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware {
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(DepLoan7NoticeGatewayHessianServiceImpl.class);
	
	@Override
	public void setApplicationContext(ApplicationContext applicationContext)
			throws BeansException {
		DepLoan7NoticeGatewayHessianServiceImpl.applicationContext = applicationContext;
	}
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.BUSINESS_DEPLOAN7_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
