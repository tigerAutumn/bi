 ...
 * 协议支付错误码
 * @project gateway
 * @title AgreementPayRespCode.java
 * @author Dragon & cat
 * @date 2018-4-1
 * @Copyright 2015 BiGangWan.com Inc. All rights reserved.
 * @Description
 */
public enum AgreementPayRespCode {
    ...
    ERROR_CODE_BF00117("BF00117", "交易金额超限，请联系宝付", "INF_FAIL"),
    ERROR_CODE_BF00118("BF00118", "报文中密文解析失败", "INF_FAIL"),
    ERROR_CODE_BF00119("BF00119", "短信验证超时，请稍后再试", "INF_FAIL"),
    ...
    ERROR_CODE_BF00130("BF00130", "请确认是否发送短信,当前交易必须通过短信验证！", "INF_FAIL"),
    ERROR_CODE_BF00131("BF00131", "当前交易信息与短信交易信息不一致,请核对信息", "INF_FAIL"),
    ERROR_CODE_BF00132("BF00132", "短信验证超时，请稍后再试", "INF_FAIL"),
    ERROR_CODE_BF00133("BF00133", "短信验证失败", "INF_FAIL"),
    ERROR_CODE_BF00134("BF00134", "绑定关系不存在", "INF_FAIL"),
    ERROR_CODE_BF00135("BF00135", "交易金额不正确", "BIZ_FAIL"),
    ERROR_CODE_BF00136("BF00136", "订单创建失败", "BIZ_FAIL"),
    ERROR_CODE_BF00137("BF00137", "个人会员不能为空", "BIZ_FAIL"),
    ERROR_CODE_BF00138("BF00138", "个人会员不存在", "BIZ_FAIL"),
    ...
    ERROR_CODE_BF00180("BF00180", "获取短信验证码失败", "INF_FAIL"),
    ERROR_CODE_BF00182("BF00182", "您输入的银行卡号有误，请重新输入", "INF_FAIL"),
    ERROR_CODE_BF00186("BF00186", "该卡已绑定", "INF_FAIL"),
    ERROR_CODE_BF00187("BF00187", "暂不支持信用卡的绑定", "INF_FAIL"),
    ERROR_CODE_BF00188("BF00188", "绑卡失败", "INF_FAIL"),
    ERROR_CODE_BF00189("BF00189", "交易金额超过限额", "INF_FAIL"),
    ERROR_CODE_BF00190("BF00190", "商户流水号不能重复", "INF_FAIL"),
    ERROR_CODE_BF00191("BF00191", "标的开始日期格式不正确", "INF_FAIL"),
    ERROR_CODE_BF00192("BF00192", "标的结束日期格式不正确", "INF_FAIL"),
    ERROR_CODE_BF00193("BF00193", "标的到期还款日期格式不正确", "INF_FAIL"),
    ERROR_CODE_BF00194("BF00194", "交易金额不正确", "INF_FAIL"),
    ERROR_CODE_BF00195("BF00195", "标的金额不正确", "INF_FAIL"),
    ERROR_CODE_BF00196("BF00196", "还款总金额不正确", "INF_FAIL"),
    ERROR_CODE_BF00197("BF00197", "年化率格式不正确", "INF_FAIL"),
    ERROR_CODE_BF00198("BF00198", "订单日期格式不正确", "INF_FAIL"),
    ERROR_CODE_BF00199("BF00199", "订单日期格式不正确", "INF_FAIL"),
    
    ERROR_CODE_BF00200("BF00200", "发送短信和支付时商户订单号不一致", "INF_FAIL"),
    ERROR_CODE_BF00201("BF00201", "发送短信和支付交易时金额不相等", "INF_FAIL"),
    ERROR_CODE_BF00203("BF00203", "退款交易已受理", "INF_FAIL"),
    ERROR_CODE_BF00204("BF00204", "确认绑卡时与预绑卡时的商户订单号不一致", "INF_FAIL"),
    ...
    ERROR_CODE_BF00238("BF00238", "交易结果未知，请稍后查询", "BIZ_FAIL"),
    ...
    ERROR_CODE_BF00334("BF00334", "分账信息格式不正确", "BIZ_FAIL"),
    ERROR_CODE_BF00335("BF00335", "分账参数验证失败", "BIZ_FAIL"),
    ERROR_CODE_BF00336("BF00336", "分账信息和之前不一致", "BIZ_FAIL"),
    ERROR_CODE_BF00337("BF00337", "分账指令已经受理", "BIZ_FAIL"),
    ERROR_CODE_BF00338("BF00338", "分账成功", "BIZ_FAIL"),
    ERROR_CODE_BF00339("BF00339", "已分账", "BIZ_FAIL"),
    ...
    ERROR_CODE_BF00436("BF00436", "交易类型不存在", "BIZ_FAIL"),
    ERROR_CODE_BF00437("BF00437", "不支持的密钥类型", "BIZ_FAIL"),
    ERROR_CODE_BF00438("BF00438", "不支持的卡类型", "BIZ_FAIL"),
    ERROR_CODE_BF00450("BF00450", "签名验证失败", "BIZ_FAIL"),
    ERROR_CODE_BF00423("BF00423", "绑卡失败，请重新签约", "BIZ_FAIL"),
     ...
     * @param status
     */
    private AgreementPayRespCode(String code, String description, String status) {
		this.code = code;
