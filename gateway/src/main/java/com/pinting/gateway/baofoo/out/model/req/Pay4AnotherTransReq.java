 ...
 */
public class Pay4AnotherTransReq extends BaoFooOutBaseReq{
    ...
    public String getTo_pro_name() {
        if(StringUtils.isBlank(to_pro_name)){
            return "";
        }
        return to_pro_name;
    }
    ...
    public String getTo_city_name() {
        if(StringUtils.isBlank(to_city_name)){
            return "";
        }
        return to_city_name;
    }
    ...
    public String getTo_acc_dept() {
        ...
        if(StringUtils.isBlank(to_acc_dept)){
            return "";
        }
        return to_acc_dept;
    }
    ...
    public String getTrans_summary() {
        if(StringUtils.isBlank(trans_summary)){
            return "";
        }
