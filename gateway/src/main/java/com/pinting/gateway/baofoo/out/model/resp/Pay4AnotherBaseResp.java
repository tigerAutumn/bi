 ...
 */
public class Pay4AnotherBaseResp<T> {

    private TransHead trans_head;

    private List<Pay4AnotherRespData<T>> trans_reqDatas;
    ...
    public List<Pay4AnotherRespData<T>> getTrans_reqDatas() {
        return trans_reqDatas;
    }

    public void setTrans_reqDatas(List<Pay4AnotherRespData<T>> trans_reqDatas) {
