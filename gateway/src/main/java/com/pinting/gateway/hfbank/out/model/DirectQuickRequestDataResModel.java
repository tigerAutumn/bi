 ...
 * Author:      cyb
 * Date:        2017/4/1
 * Description: 快捷充值预下单响应信息中的业务数据
 */
public class DirectQuickRequestDataResModel implements Serializable {

    private static final long serialVersionUID = 2272280875446733219L;
