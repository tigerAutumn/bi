 ...
 * 协议支付-直接支付类交易
 * @project gateway
 * @title B2GReqMsg_BaoFooAgreementPay_DirectAgreementPay.java
 * @author Dragon & cat
 * @date 2018-3-31
 * @Copyright 2015 BiGangWan.com Inc. All rights reserved.
 * @Description
 */
public class B2GReqMsg_BaoFooAgreementPay_DirectAgreementPay extends ReqMsg {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1972687436372655792L;
	/*报文发送日期时间*/
