...
public class ReadySign {
	...
	public static void main(String[] args) throws Exception {		
		...
		String Cardinfo = "6212262309006279753|何豪雨|310115199007129776|13588733000||";//账户信息[银行卡号|持卡人姓名|证件号|手机号|银行卡安全码|银行卡有效期]
		...
		DateArry.put("user_id", "7_DAI_SELF1741150");//用户在商户平台唯一ID
