...
//		str = str.replaceAll(" ", "+");
	 ...
	 * 解密
	 */
	public static byte[] Base64DecodeByte(String str) throws UnsupportedEncodingException, IOException {
//		str = str.replaceAll(" ", "+");
	 ...
	 * 
	 */
	public static  String AesEncryptAgreementPay(String content ,String key){
