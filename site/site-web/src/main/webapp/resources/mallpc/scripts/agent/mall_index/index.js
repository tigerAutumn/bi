...
var global = {
    ...
    current_url: '/pc_a/mall/homeIndex',
    sigIn_url:'/pc_a/mall/userSign',
    product_url : '/pc_a/mallCommodity/commodityDetail?commodityId='
};
// ******************************************  开始  *********************************************************
$(function () {
    //*################################## 方法 #################################*/
    function signIn() {//签到方法
        $.ajax({
            ...
            type: 'post',
            data: {
                "agentViewFlag":global.agentViewFlag
            },
    ...
    function linkToCard(obj) {//跳转产品详情
        ...
        var link_url = global.base_url + global.product_url + product_id + "&agentViewFlag=" +global.agentViewFlag;
        window.location.href = link_url;
    }
    function go_help_center(page) {//跳转帮助页面
        var url = global.base_url + '/gen178/platform/help/common_problem/index?agentViewFlag=' + global.agentViewFlag;
    ...
    $(".go_register").on("click", function () {
        window.location.href = global.base_url + "/gen178/user/register_first_new_index?agentViewFlag=" + global.agentViewFlag
    });
    /** 跳转产品列表*/
    $(".go_list").on("click", function () {
        window.location.href = global.base_url + "/gen178/regular/list?agentViewFlag=" + global.agentViewFlag
    });
    /** 跳转帮助*/
    ...
    $('.go_login').on('click', function() {
        window.location.href=global.base_url + "/gen178/user/login/index?agentViewFlag=" + global.agentViewFlag
    });
    /** 签到*/
