...
$(function () {
    ...
    var global = {
        ...
        product_detail_url: $('#APP_ROOT_PATH').val() + '/micro2.0/regular/index',                   // 178产品详情
    ...
    (function () {
        ...
        if(!global.from && window.localStorage.getItem('from')) {
            $('#from').val(window.localStorage.getItem('from'));
            window.localStorage.removeItem('from');
        }
        if(!global.backUrl && window.localStorage.getItem('backUrl')) {
            $('#backUrl').val(window.localStorage.getItem('backUrl'));
    ...
    function goBankList() {
        ...
        window.localStorage.setItem('from', $('#from').val());
        window.localStorage.setItem('backUrl', $('#backUrl').val());
     ...
     */
    function pageJump() {
    	if(global.entry == 'withdraw') {
            location.href = global.next_withdraw_url + '?wfrom='+ global.from  + '&backUrl=' + global.backUrl ;
        } else if(global.entry == 'top_up') {
            location.href = global.next_top_up_url + '?from='+ global.from;
        } else if(global.productId) {
            location.href = global.product_detail_url + '?id=' + global.productId + '&from=' + global.from + '&client=' + global.client;
        } else if(global.backUrl) {
