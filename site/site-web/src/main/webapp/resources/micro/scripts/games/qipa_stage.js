...
IS_TOUCH, SCREEN_SHOW_ALL = !0; (function(a, d) {
	...
	window.onload = function() {
		...
		h.noshare || a.queue.loadManifest({
			path: "/resources/micro/images/gameimg/",
			manifest: [{
				src: "share_tip.png",
				id: "share_tip"
			}]
	...
	a.showMoreGames = function(b) {
		if (null == e) {
			e = new createjs.Text("币港湾", "28px Arial", "#404040");
			e.textAlign = "right";
...
function MyProgressBar(a, d, b) {
	...
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("苟富贵勿相忘", "38px Arial", "black");
	b.x = a / 2;
	b.y = 260;
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("币港湾网址：m.bigangwan.com", "32px Arial", "black");
	b.x = a / 2;
	b.y = d - 100;
	b.textAlign = "center";
	this.addChild(b)
