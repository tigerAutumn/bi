$(function(){
		...
		$.post($('#'+currentForm).attr('action'),
			...
			function(data){
				if(data.resCode=='000'){
					...
					drawAlert("温馨提示","支付密码修改成功","确定",$("#APP_ROOT_PATH").val()+"/micro/profile/index","返回",$("#APP_ROOT_PATH").val()+"/micro/profile/index");
	...
	// 事件注册开始
	$('#modifypaySubmitButton').click(function() {
