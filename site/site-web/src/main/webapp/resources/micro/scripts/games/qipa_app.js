...
if (void 0 == APP_API_URL) var APP_API_URL = /m.bigangwan.com/.test(location.host) ? "http://m.bigangwan.com": "http://m.bigangwan.com";
if (void 0 == APP_LIST_URL) var APP_LIST_URL = "http://m.bigangwan.com";
if (void 0 == APP_FOLLOW_URL) var APP_FOLLOW_URL = "http://mp.weixin.qq.com/s?__biz=MzAwNzIzMDYyMg==&mid=204515151&idx=1&sn=cd0e39297cfaf4b9352b7251eb432896&scene=4#wechat_redirect";
...
qipaShare = {
	...
	desc: GID,
	link: document.URL,
	imgUrl: location.origin + location.pathname.replace("index.html", "") + "gameimg/ico_large.png"
};
 (function(a, f) {
