window.onload = function() {
	...
	function move() {
		...
		i++
		for (j = 0; j < aImg.length; j++) {
			aImg[j].style.background = 'url('+APP_ROOT_PATH+'/resources/gen2.0/images/static/averageCapitalPlusInterestIntro/mth3.png) no-repeat center'
			aImg1[j].style.display = 'none'
		}
		if (i == aImg.length) {

			aImg[0].style.background = 'url('+APP_ROOT_PATH+'/resources/gen2.0/images/static/averageCapitalPlusInterestIntro/mth2.png) no-repeat center'
			aImg1[0].style.display = 'block'
		} else {

			aImg[i].style.background = 'url('+APP_ROOT_PATH+'/resources/gen2.0/images/static/averageCapitalPlusInterestIntro/mth2.png) no-repeat center'
