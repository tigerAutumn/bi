...
var global = {
 ...
 function pic(obj1,obj2,obj3,obj4,obj5,obj6,obj7,obj8){
...
//			startMove(oFrame, { width:document.documentElement.clientWidth+'px', height:iHeight});
			with(oFrame.style){ width=document.documentElement.clientWidth+'px', height=iHeight}
