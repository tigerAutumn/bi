...
var global = {
    ...
    lucky_draw_url: '/gen2.0/activity/2018/year_end/lucky_draw', // 抽奖链接
    make_up_draw_url: '/gen2.0/activity/2018/year_end/make_up', // 补抽链接
    award_type: '0',
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.result.resCode == constants.code.success) {
                    ...
                    } else if(global.award_type == constants.award_type.second) {
                        $("#second_prize").html("<li class='less_list'></li>")
                    }
                    startTrun();
        ...
        if($(obj).hasClass("isStart")) {
            ...
            switch (global.award_type) {
                ...
                case constants.award_type.second:
                    ...
                    if(global.drawn_user.second.length == 10) {
                        for(var index in global.drawn_user.second) {
                            $("#second_prize").children("li").eq(index).text(global.drawn_user.second[index]);
                        }
                    } else {
                        for(var index in global.drawn_user.second) {
                            $("#second_prize").children("li").eq(index).text(global.drawn_user.lucky[index]);
                        }
                        for(var i = global.drawn_user.second.length; i < 10; i++) {
                            $("#second_prize").children("li").eq(i).text('');
                        }
                    }
                    break;
                case constants.award_type.third:
                    ...
                    if(global.drawn_user.third.length == 10) {
                        ...
                        for(var i = global.drawn_user.third.length; i < 10; i++) {
                ...
                case constants.award_type.lucky:
                    ...
                    if(global.drawn_user.lucky.length == 10) {
                        ...
                        for(var i = global.drawn_user.lucky.length; i < 10; i++) {
