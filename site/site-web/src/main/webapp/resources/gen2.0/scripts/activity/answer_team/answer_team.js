$(function(){
    ...
    // 全局变量
    var global = {
        base_path : $('#APP_ROOT_PATH_GEN').val(),
        join_team_url: '/gen2.0/activity/answer_team/join_team',
        answer_url: '/gen2.0/activity/answer_team/answer',
        current_page_url: '/gen2.0/activity/answer_team',
        login_url: '/gen2.0/user/login/index',
        check_before_activity_url: '/gen2.0/activity/common/check_before_activity',
