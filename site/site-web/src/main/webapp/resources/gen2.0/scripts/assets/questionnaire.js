...
if (!sessionStorage.back_url){
    if(!sessionStorage.inviteUrl){ //如果是从好友邀请页面跳转过来
        sessionStorage.back_url = document.referrer; //获取跳转页面
    }else {
        sessionStorage.back_url = document.referrer + sessionStorage.inviteUrl; //获取跳转页面
    }
}
