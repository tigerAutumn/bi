...
function loginlist() {
    ...
    $('.recharge_btn').on('click',function () {
        ...
        if (riskStatus == "no") {
            ...
            location.href = $("#APP_ROOT_PATH_GEN").val() + "/gen178/recharge/recharge_index" + "?agentViewFlag=" + $('#agentViewFlag').val();
        }
    })
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (isInLogin) {
                ...
                if (toRemindStr == 'YES') {
                    var strUrl = root + "/gen178/regular/index?id=" + $("#product_id").val() + "&agentViewFlag=" + $('#agentViewFlag').val();
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.hfDepGuideInfo.isOpened == "WAIT_ACTIVATE") {
                                        ...
                                        drawToast("请先开通存管");
                                        setTimeout(function () {
                                            location.href = $("#APP_ROOT_PATH_GEN").val() + "/gen178/bankcard/index?entry=buy&productId=" + id + '&amount=' + $("#money").val() + "&agentViewFlag=" + $('#agentViewFlag').val();
                                        }, 2000);
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (data) {
                                                ...
                                                if (data.resCode == 6) {
                                                    ...
                                                    $.ajax({
                                                        url: root + "/gen178/regular/oldBuyerCheck",
                                                        data: {
                                                            productId: $("#product_id").val()
                                                        },
                                                        type: "post",
