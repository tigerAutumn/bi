...
public enum AgreeTypeEnum {
    // --------------代偿协议收款确认函-------------------
    HF_YUNDAI_RECEIPTCONFIRMAGREEMENT("hf_yundai_receiptConfirmAgreement", "代偿协议收款确认函-消费循环贷(新)"),
    HF_YUNDAI_RECEIPTCONFIRMAGREEMENT_STAGE("hf_yundai_receiptConfirmAgreement_stage", "代偿协议收款确认函-等本等息，等额本息"),
    // --------------代偿协议收款确认函-------------------


    // --------------代偿协议通知书-------------------
    HF_YUNDAI_CREDITORNOTICEAGREEMENT("hf_yundai_creditorNoticeAgreement", "代偿协议通知书-消费循环贷(新)"),
