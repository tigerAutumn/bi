package com.pinting.site.weichat.util;
...
public class WeChatUtil {
    ...
    public  Map<String, String> createAuth(HttpServletRequest request) {
        ...
        if (url.equals(WeChatUtil.tokenUrl)) {
            url += "/";
        }
    ...
    private  Map<String,Object> getTokenAndTicket() {
    	...
    	ResMsg_SWxUtil_GetTokenAndTicket res = (ResMsg_SWxUtil_GetTokenAndTicket)siteService.handleMsg(new ReqMsg_SWxUtil_GetTokenAndTicket());
		String accessToken = res.getAccessToken();// 你自己的token
		String ticket = res.getJsapiTicket();
		log.info("accessToken:"+accessToken);
		log.info("ticket:"+ticket);
		map.put("accessToken", accessToken);
		map.put("ticket", ticket);
		map.put("appid", res.getAppid());
		map.put("secret", res.getSecret());
