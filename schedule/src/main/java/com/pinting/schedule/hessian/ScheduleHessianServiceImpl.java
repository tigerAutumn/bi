package com.pinting.schedule.hessian;
...
import com.pinting.schedule.exception.PTMessageException;
import com.pinting.schedule.util.Constants;

/**
 * 统一  Business Hessian接入  接口实现
 * @Project: gateway
 * @Title: ScheduleHessianServiceImpl.java
 * @author dingpf
 * @date 2015-2-10 下午2:17:40
 * @Copyright: 2015 BiGangWan.com Inc. All rights reserved.
 */
public class ScheduleHessianServiceImpl extends HessianBaseService implements HessianService , ApplicationContextAware{
	
	protected static ApplicationContext applicationContext;
	private static ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory(); 
	
	private Logger log = LoggerFactory.getLogger(ScheduleHessianServiceImpl.class);
	...
	public ResMsg handleMsg(ReqMsg reqMsg) {
		...
		try {
			...
			String resClassName = Constants.BUSINESS_SCHEDULE_MESSAGE_RESMSG_PRE + facadeName + "_" + actionName;
	...
	public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
		ScheduleHessianServiceImpl.applicationContext = applicationContext;
